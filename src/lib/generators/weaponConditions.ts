...
const memeSeries = {
	[WeaponType.Sword]: ['Sealed Nodachi', 'Elder Pain Omega', 'Silent Tree', 'D-AIS Saber'],
	...
	[WeaponType.Harmonizer]: ['Aqua Ripple', 'Millioraj Dusk', 'Rykros Staff', 'Impending Gale']
} as MemeMap;
...
const weaponApplicableClass = {
	...
	[PlayerClass.Ranger]: [WeaponType.AssaultRifle, WeaponType.Launcher, WeaponType.Gunblade],
	[PlayerClass.Gunner]: [WeaponType.AssaultRifle, WeaponType.TwinMachineGuns, WeaponType.Gunblade],
	[PlayerClass.Force]: [WeaponType.Rod, WeaponType.Talis, WeaponType.Gunblade],
	[PlayerClass.Techer]: [WeaponType.Wand, WeaponType.Talis, WeaponType.Gunblade],
	[PlayerClass.Braver]: [WeaponType.Bow, WeaponType.Katana, WeaponType.Gunblade],
	[PlayerClass.Bouncer]: [WeaponType.SoaringBlades, WeaponType.JetBoots, WeaponType.Gunblade],
	[PlayerClass.Summoner]: [WeaponType.Harmonizer, WeaponType.Gunblade],
	[PlayerClass.Hero]: [
		WeaponType.Sword,
		WeaponType.Talis,
		WeaponType.TwinMachineGuns,
	...
	[PlayerClass.Luster]: [WeaponType.Gunblade]
};
